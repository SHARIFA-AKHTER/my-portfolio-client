    ...
    <section className="relative min-h-screen py-20 px-6 sm:px-12 lg:px-20 bg-background text-foreground overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="space-y-6 bg-secondary/30 p-8 rounded-3xl border border-primary/5 shadow-inner">
              ...
              <div className="flex flex-col gap-4">
                {project.liveUrl && (
                  <a href={project.liveUrl} target="_blank" className="flex items-center justify-between p-4 bg-green-500/10 text-green-500 rounded-2xl hover:bg-green-500 hover:text-white transition-all duration-300 font-bold">
        ...
        <div className="text-center pt-6">
          <a href="/projects" className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary font-bold">
