...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full overflow-hidden pt-16 pb-8 bg-slate-950 text-slate-300 border-t border-slate-900">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-px bg-linear-to-r from-transparent via-teal-500/50 to-transparent"></div>

      <div className="container mx-auto px-6 lg:px-20">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          {/* Left: Branding & Tagline */}
          <div className="text-center md:text-left space-y-2">
            <h2 className="group text-2xl font-black tracking-tighter text-white italic">
              <span className="bg-linear-to-r from-white to-slate-400 bg-clip-text text-transparent group-hover:from-teal-400 group-hover:to-blue-500 transition-all duration-500">
                SHARIFA
              </span>
              <span className="text-teal-500 inline-block animate-pulse">
                .
              </span>
            </h2>
