...
const Navbar = () => {
  ...
  return (
    <nav 
      className="fixed top-4 inset-x-4 md:top-6 md:inset-x-8 lg:top-8 lg:inset-x-16 h-16 max-w-7xl mx-auto rounded-full bg-background/80 dark:bg-slate-900/80 backdrop-blur-md border shadow-md z-50 transition-all" 
    ...
    >
      <div className="flex h-full items-center justify-between px-4 md:px-6 lg:px-8">
        ...
        {/* Center - Menu (Links like Projects, Skills, Contact) */}
        <div className="hidden sm:flex flex-1 justify-center">
          <NavMenu className="flex gap-4 md:gap-8 font-medium" />
        </div>
