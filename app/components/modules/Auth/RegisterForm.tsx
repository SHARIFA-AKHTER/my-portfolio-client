...
export default function RegisterForm() {
  const router = useRouter();
  const form = useForm<FieldValues>({ defaultValues: { name: "", email: "", phone: "", password: "", role: "USER" } });
    ...
    <div className="flex min-h-screen justify-center items-center bg-gray-50">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 w-96 bg-white p-8 rounded-lg shadow-lg">
          ...
          <Button type="submit" className="w-full bg-blue-600 text-white">Register</Button>
