...
//                 <div>
//                   <h3 className="flex items-center gap-2 text-xl font-bold mb-3 text-foreground/90">
//                     <ExternalLink className="text-primary" size={24} /> Key
//                     Features
//                   </h3>
...
//                     target="_blank"
//                     className="flex items-center justify-between p-4 bg-foreground text-background rounded-2xl hover:opacity-90 transition-all font-bold"
//                   >
//                     <span className="flex items-center gap-3">
//                       <Github size={22} /> GitHub Repo
//                     </span>
...
//                   <span className="opacity-60 uppercase tracking-widest font-bold">
//                     Developer
//                   </span>
//                   <span className="text-foreground font-bold">
//                     {project.author?.name ?? "Sharifa"}
//                   </span>
//                 </div>
//                 <div className="flex justify-between items-center">
//                   <span className="opacity-60 uppercase tracking-widest font-bold">
...
export default async function ProjectDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (id.includes("index.html") || isNaN(Number(id))) {
    return <div className="p-20 text-center text-white">Loading...</div>;
  }

  const project = await getProjectById(id);
  if (!project) {
    return <div className="p-20 text-center text-red-500">Project Not Found! (ID: {id})</div>;
  }

  return (
    <div className="max-w-3xl mx-auto py-20 px-6 text-white bg-black min-h-screen">
      <p className="text-blue-500 font-bold mb-2">Project ID: {project.id}</p>
