      ...
      <div className="flex h-full items-center justify-between px-4 md:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 md:gap-6">
          ...
          <div className="hidden md:flex gap-3">
            <Button className="rounded-full px-4 py-2 text-sm md:text-base">
              <Link href="/login" className="w-full text-center">
                Login
              </Link>
            </Button>
            <Button className="rounded-full px-4 py-2 text-sm md:text-base border border-purple-700 text-purple-700 hover:bg-purple-50">
